...
pub type Slider<I> = Widget<SliderBase<I>, I>;
pub type RenderSlider<I> = fn(widget: &Slider<I>, interaction: Interaction);
pub type OnPress<I> = fn(f32) -> I;

pub struct SliderBase<I> {
    pub min: f32,
    pub max: f32,
    pub current: f32,
    ...
    pub render_slider: RenderSlider<I>,
    pub on_press: OnPress<I>,
}

impl<I: Clone + 'static> Slider<I> {
    pub fn new<Sty: Into<Style>>(
        ...
        Box::new(Self::new_raw(style, min, max, current, on_press))
    }
    pub fn new_raw<Sty: Into<Style>>(
        style: Sty,
        min: f32,
        max: f32,
        current: f32,
...
impl<I: Clone + 'static> Interactable<I> for Slider<I> {
    fn interact(&mut self) -> Vec<I> {
        ...
        let message = (self.custom.on_press)(self.custom.current);
        vec![message]
    }
}

impl<I> Renderable for Slider<I> {
...
fn render_slider<I: Clone + 'static>(slider: &Slider<I>, _interaction: Interaction) {
